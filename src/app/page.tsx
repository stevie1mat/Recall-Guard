...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-slate-900">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative w-full pt-20 sm:pt-28 pb-0 overflow-hidden font-sans">

        {/* Randomized Scattered Product Background Patterns */}
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none opacity-[0.04] hidden sm:block">
          {/* Sparse, well-spaced scattered background elements — hidden on mobile to reduce visual noise */}
        ...
        <div className="container mx-auto px-4 text-center max-w-5xl relative z-10 pt-4">
          ...
          {/* Announcement Pill */}
          <div className="inline-flex items-center gap-2 sm:gap-2.5 px-1.5 py-1.5 pr-3 sm:pr-5 rounded-full mb-6 sm:mb-8 cursor-default group"
            style={{
          ...
          >
            {/* Badge */}
            <span className="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-1 rounded-full text-[9px] sm:text-[10px] font-bold tracking-widest uppercase"
              style={{
            ...
            <span className="text-xs sm:text-sm font-medium text-slate-700 group-hover:text-slate-900 transition-colors">
              Now monitoring <span className="font-semibold text-slate-900">10,000+</span> Health Canada recalls
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-[2.5rem] sm:text-[3.25rem] md:text-[5rem] leading-[1.05] font-bold tracking-tighter mb-4 sm:mb-6">
          ...
          {/* Subheadline */}
          <p className="text-base sm:text-xl md:text-[1.35rem] text-slate-600 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed font-medium px-2 sm:px-0">
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 px-2 sm:px-0">
            <Button asChild className="h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full bg-[#61c554] hover:bg-[#4ea843] text-white font-semibold border-none ring-0 focus-visible:ring-0 w-full sm:w-auto shadow-[0_8px_30px_rgb(97,197,84,0.3)] transition-all hover:scale-[1.02]">
              <Link href="/signup?audience=business">Join as a Business</Link>
            </Button>
            <Button asChild variant="outline" className="h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg rounded-full bg-white/80 backdrop-blur-md border-slate-200 text-slate-700 font-semibold hover:bg-slate-50 ring-0 focus-visible:ring-0 w-full sm:w-auto hover:scale-[1.02] transition-all">
      ...
      <section className="pt-8 sm:pt-10 pb-16 sm:pb-24 px-4 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="mb-10 sm:mb-16 border-b border-slate-100 pb-6 sm:pb-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 md:divide-x divide-slate-200">
              <div className="flex items-center gap-3 md:px-8 md:justify-center">
                <div className="text-3xl sm:text-4xl font-medium tracking-tight">500+</div>
                <div className="text-[10px] sm:text-xs text-slate-500 font-semibold tracking-wide leading-tight uppercase">Trusted<br />Retailers</div>
              </div>
              <div className="flex items-center gap-3 md:px-8 md:justify-center">
                <div className="text-3xl sm:text-4xl font-medium tracking-tight">10K+</div>
                <div className="text-[10px] sm:text-xs text-slate-500 font-semibold tracking-wide leading-tight uppercase">Products<br />Monitored</div>
              </div>
              <div className="flex items-center gap-3 md:px-8 md:justify-center">
                <div className="text-3xl sm:text-4xl font-medium tracking-tight">30K+</div>
                <div className="text-[10px] sm:text-xs text-slate-500 font-semibold tracking-wide leading-tight uppercase">Database<br />Records</div>
              </div>
              <div className="flex items-center gap-3 md:px-8 md:justify-center">
                <div className="text-3xl sm:text-4xl font-medium tracking-tight">100%</div>
                <div className="text-[10px] sm:text-xs text-slate-500 font-semibold tracking-wide leading-tight uppercase">Automated<br />Sync</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 sm:mb-16 gap-4 sm:gap-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight max-w-xl leading-[1.1]">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-10 sm:mb-16">
            {/* Business card */}
            <div className="rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-[#61c554]/20 bg-gradient-to-br from-[#f0fbee] to-white shadow-[0_8px_30px_rgb(97,197,84,0.06)]">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-3">Retailers, distributors &amp; e-commerce stores</h3>
            ...
            {/* Individual card */}
            <div className="rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <div className="inline-flex items-center gap-2.5 px-1.5 py-1.5 pr-4 rounded-full mb-6 cursor-default"
                style={{
                  background: 'linear-gradient(135deg, rgba(255,255,255,0.85) 0%, rgba(255,255,255,0.6) 100%)',
              ...
              <h3 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-3">Parents, shoppers &amp; safety-conscious consumers</h3>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 sm:mb-12 gap-4 sm:gap-6">
            <h3 className="text-2xl sm:text-3xl font-medium tracking-tight leading-[1.1]">How it works</h3>
            <p className="text-sm sm:text-base text-slate-500 max-w-md leading-relaxed">Three simple steps — whether you&apos;re a business owner or an individual.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-8 relative">
            ...
            {[
              ...
              <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative z-10 transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full border border-slate-200 bg-slate-50 flex items-center justify-center text-lg sm:text-xl font-bold text-slate-900 mb-4 sm:mb-6">{s.step}</div>
                <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mb-2 sm:mb-3">{s.title}</h3>
      ...
      <div className="relative overflow-hidden bg-white">
        ...
        <section className="pt-12 sm:pt-24 pb-8 sm:pb-12 px-4 relative z-10">
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-8 sm:gap-16 items-center">
              <div className="lg:w-1/3">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight mb-4 sm:mb-6 leading-[1.1]">
                ...
                <Button asChild className="rounded-full bg-slate-900 hover:bg-slate-800 text-white font-medium px-6 sm:px-8 h-12 sm:h-14 text-base sm:text-lg w-full sm:w-auto">
                  <Link href="/signup">See it in action</Link>
                </Button>
              </div>

              <div className="lg:w-2/3 flex flex-col md:flex-row gap-4 sm:gap-6 w-full">
                {/* Left Column of Bento */}
                <div className="flex flex-col gap-4 sm:gap-6 w-full md:w-1/2">
                  <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 flex flex-col justify-center min-h-[14rem] sm:h-64 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                    <div className="mb-4">
                  ...
                  <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden flex flex-col justify-center transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                    <div className="mb-6">
                ...
                <div className="w-full md:w-1/2 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col relative overflow-hidden h-full min-h-[300px] sm:min-h-[400px] transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                  <div className="mb-8">
                    <div className="flex items-center gap-2 mb-2">
        ...
        <section className="pt-8 sm:pt-12 pb-16 sm:pb-24 px-4 relative z-10">
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-8 sm:gap-16">

              <div className="lg:w-2/3 grid sm:grid-cols-2 gap-4 sm:gap-6 order-2 lg:order-1">
                {[
                  ...
                  <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] group">
      ...
      <section className="py-12 sm:py-24 px-4 bg-white border-t border-slate-100 relative">
        <div className="container mx-auto max-w-7xl">
          <div className="mb-10 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight max-w-2xl leading-[1.1]">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
            {/* Grid of cards */}
            <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {[
            ...
            <div className="w-full lg:w-1/3 flex flex-col pt-4">
              <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-8 sm:mb-12">
              ...
              <div>
                <Button asChild className="rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-medium px-6 sm:px-8 h-12 sm:h-14 border-0 text-sm sm:text-base w-full sm:w-auto">
      ...
      <section className="py-12 sm:py-24 px-4 bg-white border-t border-slate-100">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-medium tracking-tight mb-3 sm:mb-4">Examples of recalls we catch</h2>
            <p className="text-slate-600 text-base sm:text-lg px-2 sm:px-0">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all group cursor-pointer flex flex-col h-full">
      ...
      {/* 6. CTA / SEMI-FOOTER */}
      <section className="py-16 sm:py-32 px-4 relative overflow-hidden flex flex-col items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-medium tracking-tight text-slate-900 mb-4 sm:mb-6 leading-[1.1]">
            Recall protection for everyone.
          </h2>
          <p className="text-base sm:text-xl text-slate-500 mb-6 sm:mb-10 max-w-xl mx-auto leading-relaxed px-2 sm:px-0">
            Whether you&apos;re protecting a business or just your family — set up your free account in under two minutes.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild className="rounded-full bg-[#61c554] hover:bg-[#4ea843] text-white font-semibold px-8 sm:px-10 h-12 sm:h-14 border-0 shadow-[0_8px_30px_rgb(97,197,84,0.3)] hover:scale-[1.02] transition-all text-base sm:text-lg">
              <Link href="/signup?audience=business">Join as a Business</Link>
            </Button>
            <Button asChild variant="outline" className="rounded-full px-8 sm:px-10 h-12 sm:h-14 border-slate-200 font-semibold hover:bg-slate-50 hover:scale-[1.02] transition-all text-base sm:text-lg">
              <Link href="/signup?audience=individual">Join as an Individual</Link>
            </Button>
          </div>
        </div>
